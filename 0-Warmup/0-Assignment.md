...
[Repository](https://github.com/TranAlanD/cs283)

4. Briefly describe what you want to get out of this class.
I want to get a better understanding of how to code in C even if it's not a class that focuses on coding in C. This is because I want to use it for personal projects at home. I also do want to better understand the systems I'm using and how to navigate/fix them if anything goes wrong.

5. Briefly describe any concerns you might be having with being successful in this class (if any).
I'm nervous that I may run into problems when doing the coding assignments. I believe that my ability to code in C for these assignments isn't my strongest coding language.
